...
<%@ page language="java"   import="org.apache.camel.ServiceStatus"%>
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td>
                      <c:if test="${route.serviceStatus == ServiceStatus.Suspended }">
                      <a href='<c:url value="/deeproute/suspendRoute/${route.routeid }"/>' title="启动路由" >启动</a>
                      </c:if>
                      <c:if test="${route.serviceStatus == ServiceStatus.Started }">
                      <a href='<c:url value="/deeproute/suspendRoute/${route.routeid }"/>' title="暂停路由"  >停止</a>
                      </c:if>
                      </td>
                    </tr>
                    </c:forEach>
